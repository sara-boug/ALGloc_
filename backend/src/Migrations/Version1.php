...
final class Version1 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contract_vhicle_date (id INT AUTO_INCREMENT NOT NULL, contract INT NOT NULL, vehicle INT NOT NULL, departure TIME NOT NULL, arrival TIME NOT NULL, INDEX IDX_76992CB6E98F2859 (contract), INDEX IDX_76992CB61B80E486 (vehicle), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contract_ (id INT AUTO_INCREMENT NOT NULL, client INT DEFAULT NULL, date_ INT NOT NULL, INDEX IDX_3B88C590C7440455 (client), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE contract_vhicle_date ADD CONSTRAINT FK_76992CB6E98F2859 FOREIGN KEY (contract) REFERENCES contract_ (id)');
        $this->addSql('ALTER TABLE contract_vhicle_date ADD CONSTRAINT FK_76992CB61B80E486 FOREIGN KEY (vehicle) REFERENCES vehicle (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contract_vhicle_date DROP FOREIGN KEY FK_76992CB6E98F2859');
        ...
        $this->addSql('ALTER TABLE contract_vhicle_date DROP FOREIGN KEY FK_76992CB61B80E486');
        ...
        $this->addSql('DROP TABLE contract_vhicle_date');
