...
final class Version1 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, agency INT DEFAULT NULL, model INT DEFAULT NULL, registration_number VARCHAR(255) NOT NULL, rental_price DOUBLE PRECISION NOT NULL, inssurance_price DOUBLE PRECISION NOT NULL, deposit DOUBLE PRECISION NOT NULL, passenger_number INT NOT NULL, image_ LONGBLOB NOT NULL, suitcase_number INT NOT NULL, state_ VARCHAR(200) NOT NULL, gearbox VARCHAR(100) NOT NULL, status_ VARCHAR(300) NOT NULL, INDEX IDX_1B80E48670C0C6E6 (agency), INDEX IDX_1B80E486D79572D9 (model), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
