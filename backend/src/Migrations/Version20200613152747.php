 ...
 */
final class Version20200613152747 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, city INT DEFAULT NULL, name_ VARCHAR(200) NOT NULL, familyname VARCHAR(200) NOT NULL, email VARCHAR(200) NOT NULL, password VARCHAR(200) NOT NULL, address VARCHAR(300) NOT NULL, phone_number VARCHAR(200) NOT NULL, license_number VARCHAR(200) NOT NULL, INDEX IDX_C74404552D5B0234 (city), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
