 ...
 */
final class Version20200616152732 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, city INT DEFAULT NULL, fullname_ VARCHAR(200) NOT NULL, email VARCHAR(200) NOT NULL, password VARCHAR(200) NOT NULL, address VARCHAR(300) NOT NULL, phone_number VARCHAR(200) NOT NULL, license_number VARCHAR(200) NOT NULL, INDEX IDX_C74404552D5B0234 (city), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contract_ (id INT AUTO_INCREMENT NOT NULL, client INT DEFAULT NULL, arrival_agency INT DEFAULT NULL, number_ INT NOT NULL, departure TIME NOT NULL, arrival TIME NOT NULL, date_ TIME NOT NULL, INDEX IDX_3B88C590C7440455 (client), INDEX IDX_3B88C590DABD4256 (arrival_agency), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, model INT DEFAULT NULL, registration_number VARCHAR(255) NOT NULL, rental_price DOUBLE PRECISION NOT NULL, inssurance_price DOUBLE PRECISION NOT NULL, deposit DOUBLE PRECISION NOT NULL, passenger_number INT NOT NULL, image_ LONGBLOB NOT NULL, suitcase_number INT NOT NULL, state_ VARCHAR(200) NOT NULL, gearbox VARCHAR(100) NOT NULL, status_ VARCHAR(300) NOT NULL, INDEX IDX_1B80E486D79572D9 (model), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE contract_ ADD CONSTRAINT FK_3B88C590DABD4256 FOREIGN KEY (arrival_agency) REFERENCES agency (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contract_ DROP FOREIGN KEY FK_3B88C590DABD4256');
