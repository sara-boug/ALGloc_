 ...
 */
final class Version20200612235710 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contract_ (id INT AUTO_INCREMENT NOT NULL, client INT DEFAULT NULL, number_ INT NOT NULL, departure TIME NOT NULL, arrival TIME NOT NULL, date_ TIME NOT NULL, INDEX IDX_3B88C590C7440455 (client), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, model INT DEFAULT NULL, registration_number VARCHAR(200) NOT NULL, rental_price DOUBLE PRECISION NOT NULL, inssurance_price DOUBLE PRECISION NOT NULL, passenger_number INT NOT NULL, image_ TINYBLOB NOT NULL, suitcase_number INT NOT NULL, state_ VARCHAR(200) NOT NULL, gearbox VARCHAR(200) NOT NULL, status_ VARCHAR(200) NOT NULL, INDEX IDX_1B80E486D79572D9 (model), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
