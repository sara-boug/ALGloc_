    ...
    class Home extends Component {
          ...
          <div className="filter agencyFilter rounded">
            ...
            <div className="components">
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" id="agency" name="radio-stacked" />
                <label class="custom-control-label text-monospace" for="agency">agency01</label>
              </div>
            </div>
          </div>
        );
      ...
      categoryFilter() {
        return (
          <div className="filter categoryFilter rounded">
            <div className="title">Category :  </div>
            <div className="components">
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" id="category" name="radio-stacked" />
                <label class="custom-control-label text-monospace" for="category">category01</label>
              </div>
            </div>
          </div>
        );
      ...
      modelFilter() {
        return (
          <div className="filter categoryFilter rounded">
            ...
            <div className="components">
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" id="model" name="radio-stacked" />
                <label class="custom-control-label text-monospace" for="model">Model01</label>
              </div>
            </div>
          </div>
        );
      ...
      brandFilter() {
        return (
          <div className="filter brandFilter rounded">
            <div className="title">Brand:  </div>
            <div className="components">
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" id="brand" name="radio-stacked" />
                <label class="custom-control-label text-monospace" for="brand">Brand01</label>
              </div>
            </div>
          </div>
        );
        ...
        return (
          ...
          <div className="filter-title"> Filter :</div>
           <div className="upper-filters-container">
            <div className="toast rounded-pill" role="alert" aria-live="polite" aria-atomic="true" data-autohide="false">
              <div role="alert" aria-live="assertive" aria-atomic="true" className="filter-name text-monospace" >  filter</div>
